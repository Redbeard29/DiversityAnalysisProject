...
DET_DEMO = path.join(BASE_DIR, 'Demographics/DetroitCityRaceSexAge.csv')
...
SOU_DEMO = path.join(BASE_DIR, 'Demographics/SouthfieldCityRaceSexAge.csv')
...
DET_MEAN_INCOME = path.join(BASE_DIR, 'Income/DetroitCityMeanIncome.csv')
DET_MEDIAN_INCOME = path.join(BASE_DIR, 'Income/DetroitCityMedianIncome.csv')
...
SOU_MEAN_INCOME = path.join(BASE_DIR, 'Income/SouthfieldCityMeanIncome.csv')
SOU_MEDIAN_INCOME = path.join(BASE_DIR, 'Income/SouthfieldCityMedianIncome.csv')
...
city_comparison_df = pd.DataFrame(columns=['TotalPop', 'White','Black', 'Asian', 'NativeAm', 'Other', 'TwoOrMoreRaces', 'BlackAndWhite', 'MeanIncomeHousehold', 'MeanIncomePerCap', 'MIPCWhite', 'MIPCBlack', 'MIPCWhitePercOfTot', 'MIPCBlackPercOfTot', 'MedianIncomeHousehold', 'MedHoWhite', 'MedHoBlack', 'MedHoWhitePercOfTot', 'MedHoBlackPercOfTot'],
    index=['Atlanta', 'Austin', 'Baltimore', 'Boston', 'Charlotte', 'Dallas', 'Detroit','District of Columbia', 'Greensboro', 'Los Angeles', 'New York', 'Pittsburgh', 'Raleigh', 'San Francisco', 'Seattle', 'Southfield'])
...
ATL_dict = {'demo_csv' : ATL_DEMO, 'mean_csv' : ATL_MEAN_INCOME, 'median_csv' : ATL_MEDIAN_INCOME, 'col_dict': ATL_COL, 'city_name': 'Atlanta', 'state_name': 'Georgia'}
ATX_dict = {'demo_csv' : ATX_DEMO, 'mean_csv' : ATX_MEAN_INCOME, 'median_csv' : ATX_MEDIAN_INCOME, 'col_dict': ATX_COL, 'city_name': 'Austin', 'state_name': 'Texas'}
BAL_dict = {'demo_csv' : BAL_DEMO, 'mean_csv' : BAL_MEAN_INCOME, 'median_csv' : BAL_MEDIAN_INCOME, 'col_dict': BAL_COL, 'city_name': 'Baltimore', 'state_name': 'Maryland'}
BOS_dict = {'demo_csv' : BOS_DEMO, 'mean_csv' : BOS_MEAN_INCOME, 'median_csv' : BOS_MEDIAN_INCOME, 'col_dict': BOS_COL, 'city_name': 'Boston', 'state_name': 'Massachusetts'}
CHA_dict = {'demo_csv' : CHA_DEMO, 'mean_csv' : CHA_MEAN_INCOME, 'median_csv' : CHA_MEDIAN_INCOME, 'col_dict': CHA_COL, 'city_name': 'Charlotte', 'state_name': 'North Carolina'}
DET_dict = {'demo_csv' : DET_DEMO, 'mean_csv' : DET_MEAN_INCOME, 'median_csv' : DET_MEDIAN_INCOME, 'col_dict': CHA_COL, 'city_name': 'Detroit', 'state_name': 'Michigan'}
DTX_dict = {'demo_csv' : DTX_DEMO, 'mean_csv' : DTX_MEAN_INCOME, 'median_csv' : DTX_MEDIAN_INCOME, 'col_dict': DTX_COL, 'city_name': 'Dallas', 'state_name': 'Texas'}
DC_dict = {'demo_csv' : DC_DEMO, 'mean_csv' : DC_MEAN_INCOME, 'median_csv' : DC_MEDIAN_INCOME, 'col_dict': DC_COL, 'city_name': 'District of Columbia', 'state_name': None}
GBR_dict= {'demo_csv' : GBR_DEMO, 'mean_csv' : GBR_MEAN_INCOME, 'median_csv' : GBR_MEDIAN_INCOME, 'col_dict': GBR_COL, 'city_name': 'Greensboro', 'state_name': 'North Carolina'}
LA_dict = {'demo_csv' : LA_DEMO, 'mean_csv' : LA_MEAN_INCOME, 'median_csv' : LA_MEDIAN_INCOME, 'col_dict': LA_COL, 'city_name': 'Los Angeles', 'state_name': 'California'}
NYC_dict = {'demo_csv' : NYC_DEMO, 'mean_csv' : NY_MEAN_INCOME, 'median_csv' : NY_MEDIAN_INCOME, 'col_dict': NYC_COL, 'city_name': 'New York', 'state_name': 'New York'}
PIT_dict = {'demo_csv' : PIT_DEMO, 'mean_csv' : PIT_MEAN_INCOME, 'median_csv' : PIT_MEDIAN_INCOME, 'col_dict': PIT_COL, 'city_name': 'Pittsburgh', 'state_name': 'Pennsylvania'}
RAL_dict = {'demo_csv' : RAL_DEMO, 'mean_csv' : RAL_MEAN_INCOME, 'median_csv' : RAL_MEDIAN_INCOME, 'col_dict': RAL_COL, 'city_name': 'Raleigh', 'state_name': 'North Carolina'}
SF_dict = {'demo_csv' : SF_DEMO, 'mean_csv' : SF_MEAN_INCOME, 'median_csv' : SF_MEDIAN_INCOME, 'col_dict': SF_COL, 'city_name': 'San Francisco', 'state_name': 'California'}
SEA_dict = {'demo_csv' : SEA_DEMO, 'mean_csv' : SEA_MEAN_INCOME, 'median_csv' : SEA_MEDIAN_INCOME, 'col_dict': SEA_COL, 'city_name': 'Seattle', 'state_name': 'Washington'}
SOU_dict = {'demo_csv' : SOU_DEMO, 'mean_csv' : SOU_MEAN_INCOME, 'median_csv' : SOU_MEDIAN_INCOME, 'col_dict': SEA_COL, 'city_name': 'Southfield', 'state_name': 'Michigan'}

dict_list = [ATL_dict, ATX_dict, BAL_dict, BOS_dict, CHA_dict, DTX_dict, DET_dict, DC_dict, GBR_dict, LA_dict, NYC_dict, PIT_dict, RAL_dict, SF_dict, SEA_dict, SOU_dict]
...
# def get_col_data(city_dict):
#     print(city_dict['col_dict']['Total'])
